...
for i in range(100):
    line=''
    for j in range(100):
        line+=ascii_image[i][j]*3
    labels.append(Label(master,text=line,bg='#111111',fg='#eeeeee',font=("consolas",3),pady=0,padx=0))

for i in range(100):
    labels[i].grid(row=i,sticky='W')
